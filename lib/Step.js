  ...
  _createClass(Step, [{
    ...
    value: function getStyles() {
      var _props = this.props,
          ...
          completeCircleFontColor = _props.completeCircleFontColor,
...
Step.defaultProps = {
  ...
  completedCircleFontColor: '#E0E0E0',
  size: 32,
  circleFontSize: 16,
  titleFontSize: 16,
  circleTop: 24,
...
Step.propTypes = {
  ...
  defaultCircleFontColor: _propTypes.PropTypes.string,
  activeCircleFontColor: _propTypes.PropTypes.string,
  completeCircleFontColor: _propTypes.PropTypes.string,
