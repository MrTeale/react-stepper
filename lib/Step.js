...
Step.propTypes = {
  ...
  defaultCircleFontColor: _propTypes.PropTypes.PropTypes.string,
  activeCircleFontColor: _propTypes.PropTypes.PropTypes.string,
  completeCircleFontColor: _propTypes.PropTypes.PropTypes.string,
